 ...
 * 
 */
public class BaseControllerPlugin extends PluginAdapter {
    ...
    public void setProperties(Properties properties) {
        ...
        BaseMapper = isTrue(properties.getProperty("BaseMapper")); //$NON-NLS-1$
    }
    ...
    // Set by Introspected of BaseKey class  ( extends  implements ?)Add Equals and HashCode method to Class
    /*@Override
    ...
    //Set by Introspected of PrimaryKey class  ( extends  implements ?)Add Equals and HashCode method to Class
    /*@Override
    ...
    protected void generateEquals(TopLevelClass topLevelClass,
        ...
        if (BaseMapper && topLevelClass.getSuperClass() != null) {
