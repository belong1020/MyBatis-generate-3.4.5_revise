 ...
 * 
 */
public class JavaMapperGenerator_DLC extends AbstractJavaClientGenerator {

    public JavaMapperGenerator_DLC() {
        super(true);
    }

    public JavaMapperGenerator_DLC(boolean requiresMatchedXMLGenerator) {
