...
/**
 * The Class Context. add _DLC parameter  2018-02-05
 *
 * @author Jeff Butler
 */
public class Context extends PropertyHolder {
    ...
    //2018-02-05 add dlc and set/get method, to use custom setting 
    private String dlc;
    ...
    public XmlElement toXmlElement() {
        ...
        // 2018-02-05 add _DLC state
        if (stringHasValue(dlc)) {
            xmlElement.addAttribute(new Attribute(
                    "dlc", dlc)); //$NON-NLS-1$
        }
